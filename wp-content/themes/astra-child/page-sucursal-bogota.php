  ...
  <div class="hero-content">
    ...
    <div class="hero-layout">
      <div class="hero-left">
        ...
        <p>Transportadora Estrella opera en Bogotá y Cundinamarca con flota propia certificada, seguimiento GPS 24/7 y
          el respaldo de las certificaciones ISO 9001 y BASC. Más de 30 años movilizando carga masiva desde y hacia la
          capital del país.</p>
      </div>
      <div class="hcc">
  ...
  <div class="map-section-inner">
    ...
    <div class="map-side">
      ...
      <div class="map-nav-btns">
        ...
        <a href="https://maps.google.com/?q=Av+Troncal+de+Occidente+18-76+Bogota+Colombia" target="_blank"
...
<section class="seo-intro">
  <div class="seo-intro-inner">
    <div class="seo-intro-text">
      ...
      <p>Transportadora Estrella tiene presencia activa en Bogotá como parte de su red de 8 sucursales a nivel nacional.
        Desde nuestra oficina en la Avenida Troncal de Occidente atendemos la demanda logística de empresas ubicadas en
        la capital y en toda la Sabana de Bogotá, uno de los corredores industriales más importantes del país.</p>
      <p>Bogotá concentra una alta densidad de plantas de manufactura, centros de distribución y operadores de comercio
        exterior que requieren transporte terrestre de carga masiva con trazabilidad total. Nuestra operación en la
        ciudad articula rutas directas hacia Medellín, Cali, los puertos de Buenaventura y Cartagena, y los principales
        nodos logísticos del país con flota propia y GPS 24/7.</p>
      <p>Contamos con certificación ISO 9001 de ICONTEC, certificación BASC vigente y habilitación de la
        Superintendencia de Transporte — los tres requisitos que las empresas de la Sabana exigen a sus operadores
        logísticos para garantizar cadenas de suministro seguras y auditables.</p>
    </div>
    <div class="seo-adv-grid">
      <div class="seo-adv-card">
        ...
        <div class="seo-adv-body">
          ...
          <p>Oficina en la Av. Troncal de Occidente, corredor logístico clave que conecta el centro de Bogotá con las
            zonas industriales de Fontibón, Puente Aranda y la Sabana occidental.</p>
        </div>
      </div>
      <div class="seo-adv-card">
        <div class="seo-adv-icon"><svg viewBox="0 0 24 24">
        ...
        <div class="seo-adv-body">
          ...
          <p>Desde Bogotá coordinamos entregas en toda Colombia. Sucursales propias en Medellín, Cali, Barranquilla,
            Cartagena, Buenaventura, Buga y Manizales para cobertura real en cada destino.</p>
        </div>
      </div>
      <div class="seo-adv-card">
        <div class="seo-adv-icon"><svg viewBox="0 0 24 24">
        ...
        <div class="seo-adv-body">
          ...
          <p>Certificación indispensable para empresas exportadoras e importadoras en Bogotá que operan con Buenaventura
            y Cartagena. Cadena logística libre de actividades ilícitas, verificada anualmente.</p>
        </div>
      </div>
      <div class="seo-adv-card">
        <div class="seo-adv-icon"><svg viewBox="0 0 24 24">
        ...
        <div class="seo-adv-body">
          ...
          <p>Turbos para distribución urbana en Bogotá hasta tractocamiones para carga masiva nacional. Flota propia con
            mantenimiento preventivo y revisión técnico-mecánica al día.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="cargo-types">
  <div class="cargo-types-inner">
    <div class="cargo-types-header">
      ...
      <p>Atendemos empresas con operaciones de alto volumen en la capital y la Sabana. No gestionamos paqueteo ni envíos
        individuales — nuestra especialidad es la carga masiva y semi masiva con salidas frecuentes y trazabilidad
        certificada.</p>
    </div>
    <div class="cargo-grid">
      <div class="cargo-card">
        ...
        <p>Transporte de materias primas y productos terminados para industrias ubicadas en las zonas industriales de
          Puente Aranda, Fontibón, Cazucá y la Sabana de Bogotá hacia plantas y centros de distribución en todo el país.
        </p>
      ...
      <div class="cargo-card">
        ...
        <p>Distribución de productos de consumo masivo desde los grandes centros de distribución de la Sabana hacia
          cadenas de retail, supermercados y distribuidores regionales en todo Colombia.</p>
        <a href="/servicios/transporte-de-carga-terrestre-nacional/" class="cargo-card-link">Ver servicio →</a>
      </div>
      <div class="cargo-card">
        <div class="cargo-card-num">03</div>
        <h3>Materiales de Construcción</h3>
        <p>Transporte de acero, cemento, prefabricados y agregados para proyectos de infraestructura y obra civil en
          Bogotá, Cundinamarca y los principales polos de desarrollo del corredor andino.</p>
        <a href="/servicios/transporte-de-carga-terrestre-nacional/" class="cargo-card-link">Ver servicio →</a>
      </div>
      <div class="cargo-card">
        <div class="cargo-card-num">04</div>
        <h3>Mercancías Peligrosas</h3>
        <p>Transporte especializado de químicos, pinturas, solventes y materiales clasificados bajo las 9 clases ONU
          hacia plantas industriales en Bogotá y Cundinamarca. Conductores certificados y flota equipada según Decreto
          1609.</p>
      ...
      <div class="cargo-card">
        ...
        <p>Recogida de contenedores y carga suelta en Buenaventura y Cartagena para entrega final en bodegas, plantas y
          zonas francas en Bogotá, Cundinamarca y el corredor central del país bajo certificación BASC.</p>
        <a href="/servicios/itr/" class="cargo-card-link">Ver servicio →</a>
      </div>
      <div class="cargo-card">
        <div class="cargo-card-num">06</div>
        <h3>Exportaciones ITR</h3>
        <p>Transporte de carga desde plantas y bodegas en Bogotá y la Sabana hacia los puertos de Buenaventura y
          Cartagena para operaciones de exportación con documentación completa y trazabilidad certificada.</p>
        <a href="/servicios/itr/" class="cargo-card-link">Ver servicio →</a>
      </div>
    </div>
  </div>
      ...
      <a href="/servicios/transporte-de-carga-terrestre-nacional/" class="svc-card">
        <div class="svc-img">
          <img
            ...
            alt="Transporte de carga terrestre nacional desde Bogotá Cundinamarca" loading="lazy">
      ...
      <a href="/servicios/transporte-urbano-de-mercancias/" class="svc-card">
        <div class="svc-img">
          <img src="https://transestrella.com/wp-content/uploads/2025/06/camio-urbano-de-transporte.webp"
            alt="Transporte urbano de mercancías Bogotá distribución" loading="lazy">
          <div class="svc-img-ov"></div>
      ...
      <a href="/servicios/transporte-de-carga-peligrosa/" class="svc-card">
        <div class="svc-img">
          <img src="https://transestrella.com/wp-content/uploads/2025/06/camion-cisterna.webp"
            alt="Transporte de mercancías peligrosas Bogotá Cundinamarca" loading="lazy">
          <div class="svc-img-ov"></div>
      ...
      <a href="/servicios/itr/" class="svc-card">
        <div class="svc-img">
          <img src="https://transestrella.com/wp-content/uploads/2025/08/transporte-de-contenedores.jpg"
            alt="Transporte ITR importación exportación desde Bogotá" loading="lazy">
          <div class="svc-img-ov"></div>
    ...
    <div class="fleet-chips">
      <div class="fleet-chip">
        ...
        <div>
          ...
          <div class="fleet-chip-desc">Distribución urbana Bogotá y Sabana</div>
        </div>
      </div>
      <div class="fleet-chip">
        <svg viewBox="0 0 24 24">
      ...
      <div class="fleet-chip">
        ...
        <div>
          ...
          <div class="fleet-chip-desc">Autodescargables · construcción</div>
        </div>
      </div>
      <div class="fleet-chip">
        <svg viewBox="0 0 24 24">
    ...
    <div class="directions-text">
      ...
      <div class="directions-modes">
        <div class="dir-mode">
          ...
          <p>La Av. Troncal de Occidente (Cra. 68) conecta directamente desde el norte y el sur de Bogotá. Fácil acceso
            desde la Calle 13 o la Autopista Sur. Parqueadero disponible en el edificio.</p>
        </div>
        <div class="dir-mode">
          <div class="dir-mode-header">
            <div class="dir-mode-icon"><svg viewBox="0 0 24 24">
          ...
          <p>Tomar la troncal de la Calle 13 hasta la estación <strong>Puente Aranda</strong> o la Cra. 68 con
            alimentador. A pocos minutos caminando por la Av. Troncal de Occidente hacia el No. 18-76.</p>
        </div>
        <div class="dir-mode">
          <div class="dir-mode-header">
            <div class="dir-mode-icon"><svg viewBox="0 0 24 24">
          ...
          <p>Múltiples rutas del SITP circulan por la Av. Troncal de Occidente. Bajarse en la parada más cercana a la
            Calle 18 con Troncal de Occidente, a menos de una cuadra de la sede.</p>
        </div>
      </div>
    </div>
    <div class="landmarks">
      <div class="landmark-card">
        ...
        <div class="landmark-body">
          ...
          <p>La oficina está en el corredor de Puente Aranda y Fontibón, dos de las zonas industriales más densas de
            Bogotá. Ideal para empresas con bodegas o plantas en el sector occidental de la ciudad.</p>
        </div>
      </div>
      <div class="landmark-card">
        <div class="landmark-icon"><svg viewBox="0 0 24 24">
        ...
        <div class="landmark-body">
          ...
          <p>Los vehículos de carga pesada en Bogotá están sujetos a restricciones horarias según el Decreto de
            Movilidad vigente. Consultar con nuestro equipo local antes de programar cargues o descargues en zonas
            restringidas.</p>
        </div>
      </div>
      <div class="landmark-card">
        ...
        <div class="landmark-body">
          ...
          <p>Lunes a viernes 8:00am–6:00pm · Sábados 8:00am–1:00pm. Para visitas comerciales o reuniones de operación,
            llamar al 312 826 5078 con anticipación.</p>
        </div>
      </div>
      <div class="landmark-card">
        <div class="landmark-icon"><svg viewBox="0 0 24 24">
        ...
        <div class="landmark-body">
          <h5>Parqueadero</h5>
          <p>Parqueadero disponible en el edificio Torre A. Solicitar acceso al llegar a la recepción del piso 3,
            Oficina 301.</p>
        </div>
      </div>
    </div>
...
<section class="cta">
  <div class="cta-inner">
    <div class="cta-text">
      ...
      <p>Cuéntenos el tipo de carga, la ruta y el volumen. El equipo de nuestra sucursal en Bogotá le diseña la solución
