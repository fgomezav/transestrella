<?php
/**
 * Template para las categorías del blog (excepto comunicados, que usa su propia plantilla).
 * Basado en home.php
 */
...
<section class="hero">
    ...
    <div class="hero-inner">
        ...
        <div class="hero-text">
            <div class="eyebrow">Categoría del blog</div>
            <h1>
                <?php single_cat_title(); ?>
            </h1>
            ...
            <p>Artículos, novedades y guías relacionadas con
                <?php single_cat_title(); ?>.
            </p>
            <?php
endif; ?>
...
<div class="cats">
    <div class="cats-inner">
        <a href="<?php echo get_post_type_archive_link('post'); ?>" class="cat-btn">Todos</a>
        <?php foreach ($categories as $category): ?>
        <?php if ($category->slug !== 'uncategorized'): ?>
        <a href="<?php echo esc_url(get_category_link($category->term_id)); ?>"
            class="cat-btn <?php echo ($current_category && $current_category->term_id == $category->term_id) ? 'active' : ''; ?>">
...
<section class="articles">
    <div class="articles-inner">
        ...
        <div class="articles-grid">
            <p style="text-align: center; width: 100%; grid-column: 1 / -1; padding: 40px;">Aún no hay artículos
                publicados en esta categoría.</p>
        </div>
    </div>
</section>
<?php
...
<section class="newsletter">
    <div class="newsletter-inner">
        ...
        <div class="nl-form">
            ...
            <p class="nl-privacy">Al suscribirse acepta nuestra <a href="/politica-privacidad/">Política de
                    Privacidad</a>
    ...
    <div class="topics-inner">
        ...
        <div class="topics-grid">
            <a href="/blog/category/normativa/" class="topic-card">
                ...
                <div class="topic-desc">Decreto 1609, ISO 9001, BASC, SuperTransporte, regulación de carga peligrosa y
                    normativa
            ...
            <a href="/blog/category/comercio-exterior/" class="topic-card">
                ...
                <div class="topic-desc">Operaciones ITR, terminales portuarios, documentación aduanera, DIAN, agentes de
                    carga y
            ...
            <a href="/blog/category/flota-seguridad/" class="topic-card">
                ...
                <div class="topic-desc">Seguimiento vehicular, mantenimiento preventivo, reducción de siniestros,
                    seguridad en
