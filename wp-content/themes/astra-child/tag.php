<?php
/**
 * Template para las etiquetas (tags) del blog.
 * Basado en category.php
 */
...
<section class="hero">
    ...
    <div class="hero-inner">
        ...
        <div class="hero-text">
            <div class="eyebrow">Etiqueta del blog</div>
            <h1>
                <?php single_tag_title(); ?>
            </h1>
            ...
            <p>Artículos, novedades y guías etiquetadas con "
                <?php single_tag_title(); ?>".
            </p>
            <?php
endif; ?>
...
<!-- CATEGORÍAS (Para navegación rápida) -->
<?php
...
<section class="articles">
    <div class="articles-inner">
        <div class="articles-header">
            <h3>Artículos etiquetados con <span>
                    <?php single_tag_title(); ?>
                </span></h3>
        </div>
    ...
    <div class="articles-inner">
        ...
        <div class="articles-grid">
            <p style="text-align: center; width: 100%; grid-column: 1 / -1; padding: 40px;">Aún no hay artículos
                publicados con esta etiqueta.</p>
        </div>
    </div>
</section>
<?php
