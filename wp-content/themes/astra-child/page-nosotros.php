    ...
    <div class="about-visual">
      <div class="about-stat-grid">
        <div class="about-stat">
          <div class="about-stat-num">1980</div>
          <div class="about-stat-label">Año de fundación</div>
        </div>
        <div class="about-stat">
          <div class="about-stat-num">30+</div>
          <div class="about-stat-label">Años de trayectoria en el sector</div>
        </div>
        <div class="about-stat">
          <div class="about-stat-num">1.000+</div>
          <div class="about-stat-label">Clientes que confían su carga</div>
        </div>
        <div class="about-stat">
          <div class="about-stat-num">8</div>
          <div class="about-stat-label">Sucursales nacionales</div>
        </div>
      </div>
...
<section class="mvv">
  <div class="mvv-inner">
    <div class="mvv-header">
      <div class="eyebrow center">Direccionamiento estratégico</div>
      <h2>Misión, Visión <span>y Valores</span></h2>
      <p>Los principios que guían cada operación logística que realizamos en Colombia.</p>
    </div>
    <div class="mvv-grid">
      <!-- MISIÓN -->
...
<section class="partners">
  <div class="partners-inner">
    <div class="partners-header">
      <div class="eyebrow center">Red de colaboradores</div>
      <h2>Nuestros <span>Aliados Estratégicos</span></h2>
      <p>Trabajamos con socios de confianza para ofrecer soluciones logísticas integrales a nuestros clientes.</p>
    </div>
    ...
    <div class="cta-contacts">
      ...
      <div class="cta-contact">
        ...
        <div>
          ...
          <div class="cta-c-val">Calle 64 #56-60, Medellín</div>
        </div>
      </div>
    </div>
  </div>
