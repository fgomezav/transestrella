  ...
  <div class="hero-content">
    ...
    <div class="hero-layout">
      <div class="hero-left">
        ...
        <p>Más de 30 años operando como empresa de transporte de carga masiva en Medellín y Antioquia. Flota propia certificada, monitoreo GPS 24/7 y el respaldo de las certificaciones ISO 9001 y BASC para proteger cada tonelada de su mercancía.</p>
      </div>
      <div class="hcc">
        ...
        <div class="hcc-btns">
          <a href="https://wa.me/576045273300?text=Hola%2C%20quiero%20cotizar%20transporte%20de%20carga%20en%20Medell%C3%ADn" target="_blank" class="hcc-btn hcc-btn-wa">
  ...
  <div class="map-section-inner">
    ...
    <div class="map-side">
      ...
      <div class="map-nav-btns">
        ...
        <a href="https://maps.google.com/?q=Calle+64+%2356-60+La+Candelaria+Medellin" target="_blank" class="map-nav-btn btn-gmaps">
...
<section class="seo-intro">
  <div class="seo-intro-inner">
    <div class="seo-intro-text">
      ...
      <p>Transportadora Estrella es una empresa de transporte de carga masiva con sede principal en Medellín desde 1993. Durante más de tres décadas hemos operado en Antioquia y en todos los corredores logísticos del país, consolidándonos como uno de los transportadores de referencia para empresas que mueven grandes volúmenes de mercancía en Colombia.</p>
      <p>Desde nuestra sede en La Candelaria coordinamos operaciones diarias hacia Bogotá, Cali, Barranquilla, Cartagena, Buenaventura y el resto del territorio nacional, con flota propia certificada y sistemas de monitoreo vehicular que garantizan visibilidad total sobre cada cargue.</p>
      <p>Contamos con certificación ISO 9001 de ICONTEC, certificación BASC vigente y habilitación de la Superintendencia de Transporte, lo que nos convierte en el aliado logístico que empresas de manufactura, agroindustria, construcción y comercio exterior en Medellín necesitan para operar con seguridad y trazabilidad.</p>
    </div>
    <div class="seo-adv-grid">
      <div class="seo-adv-card">
        ...
        <div class="seo-adv-body">
          ...
          <p>Sede principal activa desde 1993. Conocemos cada ruta, cada restricción de movilidad y cada particularidad logística de Antioquia y sus municipios.</p>
        </div>
      </div>
      <div class="seo-adv-card">
        ...
        <div class="seo-adv-body">
          ...
          <p>Todos nuestros vehículos operan con sistema de rastreo satelital en tiempo real. Usted puede verificar la ubicación de su carga en cualquier momento durante el tránsito.</p>
        </div>
      </div>
      <div class="seo-adv-card">
        ...
        <div class="seo-adv-body">
          ...
          <p>Turbos, camiones, volcos, patinetas, tractocamiones y cisternas con mantenimiento preventivo riguroso. El vehículo adecuado para cada tipo y volumen de carga masiva.</p>
        </div>
      </div>
      <div class="seo-adv-card">
        <div class="seo-adv-icon"><svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/></svg></div>
        <div class="seo-adv-body">
          <h4>Equipo Local Especializado</h4>
          <p>Personal operativo, comercial y de servicio al cliente con sede permanente en Medellín. Atención directa sin intermediarios ni call centers externos.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="cargo-types">
  <div class="cargo-types-inner">
    <div class="cargo-types-header">
      ...
      <p>Nos especializamos en carga masiva y semi masiva de alto volumen para empresas. No gestionamos paqueteo ni envíos individuales — nuestra operación está diseñada para volúmenes significativos con salidas frecuentes.</p>
    </div>
    <div class="cargo-grid">
      <div class="cargo-card">
        <div class="cargo-card-num">01</div>
        <h3>Materias Primas Industriales</h3>
        <p>Transporte de materias primas para industrias de manufactura, química, textil y plásticos ubicadas en el Valle de Aburrá, con origen o destino en puertos o zonas de producción en otras regiones del país.</p>
      ...
      <div class="cargo-card">
        ...
        <p>Transporte de agregados, cemento, acero, prefabricados y materiales de construcción hacia obras en todo Antioquia y Colombia. Volcos autodescargables y camiones de plataforma para cualquier formato.</p>
        <a href="/servicios/transporte-de-carga-terrestre-nacional/" class="cargo-card-link">Ver servicio →</a>
      </div>
      <div class="cargo-card">
        <div class="cargo-card-num">03</div>
        <h3>Carga de Consumo Masivo</h3>
        <p>Distribución de productos terminados de empresas de consumo masivo desde centros de distribución en Medellín hacia cadenas de retail, supermercados y distribuidores en todo el país.</p>
      ...
      <div class="cargo-card">
        ...
        <p>Transporte especializado de químicos, combustibles y materiales clasificados bajo las 9 clases ONU con conductores certificados SENA, documentación completa y flota equipada según normativa colombiana vigente.</p>
      ...
      <div class="cargo-card">
        ...
        <p>Transporte de contenedores llenos (FCL) y carga suelta desde plantas y bodegas en Medellín hacia los puertos de Buenaventura y Cartagena para operaciones de exportación bajo certificación BASC.</p>
        <a href="/servicios/itr/" class="cargo-card-link">Ver servicio →</a>
      </div>
      <div class="cargo-card">
        <div class="cargo-card-num">06</div>
        <h3>Importaciones en Puerto</h3>
        <p>Recogida de carga importada en Buenaventura y Cartagena para entrega final en bodegas, plantas o centros de distribución en Medellín, Antioquia y el corredor central del país.</p>
        <a href="/servicios/itr/" class="cargo-card-link">Ver servicio →</a>
      </div>
    </div>
  </div>
...
<section class="services">
  <div class="services-inner">
    <div class="services-header">
      ...
      <p>Todos los servicios de Transportadora Estrella se contratan y coordinan directamente desde nuestra sede en Medellín.</p>
    </div>
    <div class="services-grid">
      <a href="/servicios/transporte-de-carga-terrestre-nacional/" class="svc-card">
        <div class="svc-img">
          <img src="https://transestrella.com/wp-content/uploads/2025/04/transportadora-estrella-nuestra-flota-transporte-de-carga-pesada-1.jpeg" alt="Transporte de carga terrestre nacional desde Medellín" loading="lazy">
      ...
      <a href="/servicios/transporte-urbano-de-mercancias/" class="svc-card">
        <div class="svc-img">
          <img src="https://transestrella.com/wp-content/uploads/2025/06/camio-urbano-de-transporte.webp" alt="Transporte urbano de mercancías Medellín Valle de Aburrá" loading="lazy">
          <div class="svc-img-ov"></div>
      ...
      <a href="/servicios/transporte-de-carga-peligrosa/" class="svc-card">
        <div class="svc-img">
          <img src="https://transestrella.com/wp-content/uploads/2025/06/camion-cisterna.webp" alt="Transporte de mercancías peligrosas Medellín Antioquia" loading="lazy">
          <div class="svc-img-ov"></div>
      ...
      <a href="/servicios/itr/" class="svc-card">
        <div class="svc-img">
          <img src="https://transestrella.com/wp-content/uploads/2025/08/transporte-de-contenedores.jpg" alt="Transporte ITR importación exportación desde Medellín" loading="lazy">
          <div class="svc-img-ov"></div>
  ...
  <div class="fleet-strip-inner">
    ...
    <div class="fleet-chips">
      <div class="fleet-chip">
        ...
        <div><div class="fleet-chip-name">Turbos</div><div class="fleet-chip-desc">Distribución urbana · carga ligera</div></div>
      </div>
      <div class="fleet-chip">
        <svg viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 5v4h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
      ...
      <div class="fleet-chip">
        <svg viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 5v4h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
        <div><div class="fleet-chip-name">Volcos</div><div class="fleet-chip-desc">Autodescargables para granel</div></div>
      </div>
      <div class="fleet-chip">
        <svg viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 5v4h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
      ...
      <div class="fleet-chip">
        <svg viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 5v4h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
        <div><div class="fleet-chip-name">Tractocamiones</div><div class="fleet-chip-desc">Máxima capacidad · ITR puertos</div></div>
      </div>
      <div class="fleet-chip">
    ...
    <div class="directions-text">
      ...
      <div class="directions-modes">
        <div class="dir-mode">
          ...
          <p>Acceso directo por la Calle 64 desde el Centro de Medellín, a pocas cuadras de la Avenida Oriental y el sector de La Candelaria. Parqueadero disponible en la zona.</p>
        </div>
        <div class="dir-mode">
          <div class="dir-mode-header">
          ...
          <p>Bajarse en la estación <strong>Parque Berrío</strong> (Línea A) y caminar aproximadamente 8 minutos hacia occidente por la Calle 58 hasta la Calle 64.</p>
        </div>
        <div class="dir-mode">
          <div class="dir-mode-header">
          ...
          <p>Múltiples rutas del SITVA pasan por la Avenida Oriental. Bajarse en el cruce de Av. Oriental con Calle 64, a media cuadra de la sede.</p>
        </div>
      </div>
    </div>
    <div class="landmarks">
      <div class="landmark-card">
        ...
        <div class="landmark-body">
          ...
          <p>Parque de Berrío, Centro Administrativo La Alpujarra, Palacio de la Cultura Rafael Uribe Uribe, Banco de la República.</p>
        </div>
      </div>
      <div class="landmark-card">
        ...
        <div class="landmark-body">
          ...
          <p>Para camiones y tractocamiones: acceso por la Calle 64 en los horarios permitidos por la Secretaría de Movilidad de Medellín. Consultar restricciones vigentes antes de programar visitas con vehículos pesados.</p>
        </div>
      </div>
      <div class="landmark-card">
        ...
        <div class="landmark-body">
          ...
          <p>Lunes a viernes 8:00am–6:00pm · Sábados 8:00am–1:00pm. Se recomienda llamar al PBX (604) 527 3300 con anticipación para agendar la visita.</p>
        </div>
      </div>
      <div class="landmark-card">
        ...
        <div class="landmark-body">
          <h5>Parqueadero</h5>
          <p>Parqueaderos públicos disponibles en la zona de La Candelaria. El más cercano a media cuadra sobre la Carrera 56.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="cta">
  <div class="cta-inner">
    <div class="cta-text">
      ...
      <p>Cuéntenos el tipo de carga, la ruta y el volumen. El equipo de nuestra sede principal en Medellín le diseña la solución logística ideal y le responde en menos de 24 horas hábiles.</p>
    ...
    <div class="form-box">
      ...
      <a href="https://wa.me/576045273300?text=Hola%2C%20quiero%20cotizar%20transporte%20de%20carga%20en%20Medell%C3%ADn" target="_blank" class="form-wa">
